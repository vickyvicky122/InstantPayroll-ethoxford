...
export interface ICoreVaultClientContract
  extends Truffle.Contract<ICoreVaultClientInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<ICoreVaultClientInstance>;
}
...
export interface ICoreVaultClientInstance extends Truffle.ContractInstance {
