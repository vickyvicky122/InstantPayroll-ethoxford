...
export interface IFdcVerificationContract
  extends Truffle.Contract<IFdcVerificationInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<IFdcVerificationInstance>;
}
